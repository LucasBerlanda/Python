...
class RegistraTipoBombaForm(FlaskForm):
    ...
    rolamentoDianteiro = SelectField('Rolamento Dianteiro:', validators=[DataRequired("Por favor, preencha o campo.")], choices=[' ',], coerce=int)
    rolamentoTraseiro = SelectField('Rolamento Traseiro:', validators=[DataRequired("Por favor, preencha o campo.")], choices=[], coerce=int)
...
class ResetPasswordForm(FlaskForm):
    password = PasswordField('Password', validators=[DataRequired("Por favor, preencha o campo.")])
    password2 = PasswordField(
        'Repeat Password', validators=[DataRequired("Por favor, preencha o campo."), EqualTo('password')])
